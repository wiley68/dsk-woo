...
class Dskapi_Client {
	 ...
	 */
	public static function get( $endpoint, $params = array(), $options = array() ) {
	 ...
	 * @return array|null Decoded JSON response or null on failure.
	 */
	public static function post( $endpoint, $data = array(), $options = array() ) {
	 ...
	 * @return array|null Decoded JSON response or null on failure.
	 */
	public static function post_json( $endpoint, $data = array(), $options = array() ) {
		$options['json'] = true;
	 ...
	 */
	private static function build_url( $endpoint, $params = array() ) {
	 ...
	 * @return array|null Decoded JSON response or null on failure.
	 */
	private static function request( $url, $method = 'GET', $data = null, $options = array() ) {
	...
	public static function get_reklama( $cid = null ) {
		...
		return self::get( '/function/getrek.php', array( 'cid' => $cid ) );
	}
	...
	public static function get_minmax( $cid = null ) {
		$cid = $cid ?? self::get_cid();
		return self::get( '/function/getminmax.php', array( 'cid' => $cid ) );
	}
	...
	public static function get_eur( $cid = null ) {
		$cid = $cid ?? self::get_cid();
		return self::get( '/function/geteur.php', array( 'cid' => $cid ) );
	}
